<template>
  <div class="container">
      ...
      <el-divider class="div1"></el-divider>
         <div class="main">
            <div class="left">
                <div class="pic1"><img src="../../assets/workinfo/1.webp" alt=""></div>
                <el-upload
                class="upload-demo"
            ...
            <div class="right">
                ...
                <div class="rows-f">
                    ...
                    <span class="num">{{commander_ID}}</span>    
                </div>
                 <div class="rows-f">
                ...
                <el-button  size="mini" type="text" @click="PasswordChangeDialogVi = true" round>修改密码</el-button>
                 <el-button  size="mini" type="text" @click="EmailChangeDialogVi = true" round>更换邮箱</el-button>
                </div>

                <el-form ref="eform" :model="eform" class="eform" hide-required-asterisk="false" @submit.native.prevent>
                  <el-dialog
                    title="更换您的邮箱"
                    ...
                    :close-on-press-escape= "false">
                        ...
                        label="请输入新的邮箱号码："
                        >
                            <el-input v-model="eform.emailChange" placeholder="请输入新的邮箱号码"   suffix-icon="el-icon-message"></el-input>
                        </el-form-item>
                        <span  slot="footer" class="dialog-footer">
                                <el-form-item>
                                    <el-button @click="EmailChangeDialogVi = false,resetForm('eform')">取消更改</el-button>
                                    <el-button type="primary" size= "medium" @click="changeEmail(),resetForm('eform')">确认更改</el-button>
                                </el-form-item>
                        </span> 
                 </el-dialog>
                </el-form>
                ...
                <el-form ref="password" :model="password" class="password" hide-required-asterisk="false" >
                 <el-dialog
                    title="更改您的密码"
...
export default {
  ...
  data() {
      return {
        ...
        commander_name:'乔丹',
        phoneNum:'88888888',
        Commander_Email:'88888888@qq.com',
    ...
    methods: {
      ...
      beforeAvatarUpload(file) {
       ...
       changeEmail()
      {
          if(!/^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/.exec(this.eform.emailChange))
          {
               this.$message.warning("请检查邮箱号码格式");
               return;
          }
          ...
          this.Commander_Email=this.eform.emailChange;
      },
      changePhone()
      {
