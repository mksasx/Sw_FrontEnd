<template>
  <div>
    ...
    >
      ...
      <el-table-column label="合同操作" width="240" align="center">
        <template slot-scope="scope">
          <el-button type="primary" icon="el-icon-download" size="mini" @click="ContractVi=true,saveInfo(scope.row)" >审查合同</el-button>
    ...
    <span slot="footer" class="dialog-footer">
              <el-button
                @click="(ContractVi = false),ReturnContract(tmp)"
                >驳回合同</el-button
              >
              <el-button
                type="primary"
                size="medium"
                @click="(ContractVi = false), AuthorContract(tmp)"
                >认证合同</el-button
              >
        </span>
    </el-dialog>
    ...
    handleCurrentChange: function (currentPage) {
     ...
     getinfo() {
      this.$axios({
        ...
        url: "http://localhost:8090/UnManaged_Contract/" /* 指明后端 api 路径，由于在 main.js 已指定根路径，因此在此处只需写相对路由 */,
        data: qs.stringify({
